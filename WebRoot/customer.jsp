  ...
  <div  class="header">
    ...
    <div id="menu">
      <ul>
		...
		<li class="selected"><a href="Login.jsp">亲爱的用户<%=ActionContext.getContext().getSession().get("username") %>,欢迎登陆网上书店</a></li>
      </ul>
    </div>
  </div>
    ...
    <tr>
      ...
      <td width="444"><div align="center">
        <s:form namespace="/bookshop" method="post" action="order_cardlist">
          ...
          <input name="Submit2" type="submit" class="button" value="查看您的购物车信息" />
                </s:form>
        </div></td>
    </tr>
    <tr><s:form namespace="/bookshop" method="post" action="book_search"><td align="center"> 请输入您要搜索的书名：<br>
        <input type="text" class="SearchBar" name="searchname" />
        </td>
      <td height="145" colspan="2">
          <div align="center">
            <input name="Submit3" type="submit" class="button" value="搜索查看图书信息" />
