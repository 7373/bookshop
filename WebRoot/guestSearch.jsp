<%@ page  contentType="text/html; charset=gb2312"language="java" import="java.sql.*,java.util.*,com.opensymphony.xwork2.ActionContext,com.bookshop.entity.*,com.bookshop.action.*,javax.servlet.*,javax.servlet.http.*" %>
