  ...
  <table width="897" height="311" border="0">
    <tr>
      <td width="217" height="160"><s:form namespace="/bookshop" action="book_list"  method="post">
        <label>
          <div align="center">
            <input name="Submit" type="submit" class="button" value="查看所有图书信息" />
          </div>
        </label>
      </s:form>      </td>
      <td width="218"><form id="form4" name="form4" method="post" action="BookAdd.jsp">
        <label>
        <div align="center">
          <input name="Submit4" type="submit" class="button" value="增加新的图书信息" />
        </div>
        </label>
      </form></td>
      <td width="221"><div align="center">
        <s:form namespace="/bookshop" method="post" action="order_cartlist">
          <input name="Submit2" type="submit" class="button" value="查看所有订单信息" />
                </s:form>
        </div></td>
      <td width="221"><form  method="post" action="bookDelete.jsp">
        <label> </label>
        <div align="center">
          <input name="Submit5" type="submit" class="button" value="删除已有图书信息" />
        </div>
      </form></td>
    </tr>
    <tr><s:form namespace="/bookshop" method="post" action="book_search"><td align="center">请输入您要搜索的书名：
            <input type="text" name="searchname" class="SearchBar" />
    </td>
        <td align="center"><input name="Submit3" type="submit" class="button" value="搜索查看图书信息" /></td></s:form>
        <s:form namespace="/bookshop" method="post" action="book_searchforupdate"><td align="center">请输入您要修改的书名：
            <input name="name" type="text"  class="SearchBar"/>
    </td>
        <td align="center"><input name="Submit3" type="submit" class="button" value="查看修改图书信息" /></td></s:form>
    </tr>
  </table>
 <p>&nbsp;</p> <p>&nbsp;</p>
 <div class="clear">
