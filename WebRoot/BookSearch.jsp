<%@ page  contentType="text/html; charset=gb2312"language="java" import="java.sql.*,java.util.*,com.opensymphony.xwork2.ActionContext,com.bookshop.entity.*,com.bookshop.action.*,javax.servlet.*,javax.servlet.http.*" errorPage="wrong.jsp" %>
  ...
  <div  class="header">
    ...
    <div id="menu">
      <ul>
		...
		<li class="selected"><a href="admin.jsp">管理员界面</a></li>
      </ul>
    </div>
  </div>
		...
		<table width="596" height="259" border="0" align="center" bordercolor="#000000">
          <tr>
            <td colspan="2" rowspan="4"><img src="<%=book.getImage()%>" width="140" height="200" align="top" /></td>
            <td height="60" colspan="4"><div align="center"><span class="STYLE2"><%=book.getName()%></span> </div></td>
          </tr>
          <tr>
            <td width="66" height="57"><div align="center" class="STYLE3">作 者：</div></td>
          ...
          <tr>
            ...
            <td><div align="center"><%=book.getPrice()%>元</div></td>
		...
		<div align="center">
		  <table width="593" border="0" class="button">
            ...
            <tr>
              <td width="537" height="78"> <p>&nbsp;&nbsp;<span class="STYLE5"><%=book.getContents()%></span></p></td>
            </tr>
                  </table>
  </div>
		<p>&nbsp;</p>
