...
<%         
			 ...
			 List<Book> ems =(List<Book>)ActionContext.getContext().getSession().get("book");
 		%><%
			if (ems!=null)for(Book em: ems){
		%>
<table width="596" height="215" border="0" align="center" bordercolor="#000000">
  ...
  <tr>
    ...
    <td><div align="center"><%=em.getPrice()%>元</div></td>
...
输入购买的书名：<input type="text" name="bookname" id="bookname" size="10">
购买数量：<input type="text" name="counts" id="counts" size="10">
用户名：<input type="text" name="admin" id="admin" size="10">
<input type="submit" value="加入购物车"></s:form>
<div >
    <div align="center">
      <table> 
        <TR>
